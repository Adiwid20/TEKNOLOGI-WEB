<x-admin-layout>
    ...
    <form action="{{ route('update',['id' => $data->package_id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
                                ...
                                <div class="bg-white px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        {{-- <div class="col-span-6 sm:col-span-3">
                                            <label for="package" class="block text-sm font-medium text-gray-700">ID
                                                Package</label>
                                            <input type="text" name="package_id" id="package"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="last-name"
                                                class="block text-sm font-medium text-gray-700">ID Kategori</label>
                                            <input type="text" name="id_category" id="category" value="{{-- {{ $data->category->category_name }} --}}"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="package"
                                                class="block text-sm font-medium text-gray-700">Package Name</label>
                                            <input type="text" name="name_package" id="package" value="{{ $data->name_package }}"
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <input type="text" name="comunity_id" id="email-address" value="{{ $data->community_id }}"
                                                autocomplete="email"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        </div>
                                        ...
                                        <div class="col-span-6">
                                            <label for="street-address"
                                                class="block text-sm font-medium text-gray-700">Fasilitas
                                            </label>
                                            <input type="text" name="facility" id="facility" value=" {{$data->facility}}"
                                ...
                                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-3 gap-6">
                                        <div class="col-span-3 sm:col-span-2">
                                            <label for="location"
                                                class="block text-sm font-medium text-gray-700">Lokasi Maps Link</label>
                                    ...
                                    <div>
                                        <label for="descriptiosn" class="block text-sm font-medium text-gray-700">Deskripsi
                                        </label>
                                        <div class="mt-1">
                                            <textarea id="" name="descriptions" rows="3" 
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                placeholder="Wista berikut adalah "></textarea>
                                        </div>
                                    ...
                                    <div class="col-span-2">
                                        <label for="street-address"
                                            class="block text-sm font-medium text-gray-700">Upload Foto
                                        </label>
    ...
    </div> --}} {{-- <div class="mt-10 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Notifications</h3>
                    <p class="mt-1 text-sm text-gray-600">Decide which communications you'd like to receive and how.
                    </p>
                </div>
            </div>
            <div class="mt-5 md:col-span-2 md:mt-0">
                                ...
                                <div class="mt-4 space-y-4">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="push-email"
                                            class="ml-3 block text-sm font-medium text-gray-700">Same as email</label>
                                    </div>
                                    <div class="flex items-center">
