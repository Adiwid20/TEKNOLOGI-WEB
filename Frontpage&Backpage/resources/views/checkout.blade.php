<x-app-layout>
    <!-- component -->
    {{-- <div class="flex items-center justify-center py-8 mt-34">
    ...
    {{-- <div class=" mt-24 w-full h-full bg-gray-400 dark:bg-gray-700 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0"
        id="chec-div"> --}}
        <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
        {{-- <div class="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700"
            id="checkout"> --}}
            <div class="flex items-end lg:flex-row flex-col justify-around" id="cart">
                <div class="my-24 lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-24 md:px-6 px-4 md:py-16 py-4 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto"
                    id="scroll">
                    ...
                    <p class="lg:text-4xl text-3xl font-black leading-10 text-gray-800 dark:text-white pt-4">Pesanan yang dipilih</p>
                    <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                        ...
                        <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                            <p class="text-xs leading-3 text-gray-800 dark:text-white md:pt-0 pt-4">Bali Travel</p>
                            <div class="flex items-center justify-between w-full pt-1">
                                <p class="text-base font-black leading-none text-gray-800 dark:text-white">Kecak Fire Gianyar
                                    </p>
                            ...
                            <p class="w-96 text-xs leading-3 text-gray-600 dark:text-white">Composition: 100% calf
                                leather</p>
                    ...
                    <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                        ...
                        <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                            ...
                            <div class="flex items-center justify-between w-full pt-1">
                                <p class="text-base font-black leading-none text-gray-800 dark:text-white">Heaven's Gate Lempuyang
                                </p>
                                {{-- <select aria-label="Select quantity"
                                    class="py-2 px-1 border border-gray-200 mr-6 focus:outline-none dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
                                    <option>01</option>
                    ...
                    <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                        ...
                        <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                            <p class="text-xs leading-3 text-gray-800 dark:text-white md:pt-0 pt-4">RF293</p>
                            <div class="flex items-center justify-between w-full pt-1">
                                <p class="text-base font-black leading-none text-gray-800 dark:text-white">LW sneakers
                                </p>
                                {{-- <select aria-label="Select quantity"
                                    class="py-2 px-1 border border-gray-200 mr-6 focus:outline-none dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
                                    <option>01</option>
