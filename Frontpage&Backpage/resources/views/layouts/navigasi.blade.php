<header class="fixed w-full">
    <nav class="bg-white  border-gray-200 py-3 dark:bg-gray-900 relative">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            <a href="{{ route('home') }}" class="flex text-green-700 dark:text-green-400">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-slack"
                    viewBox="0 0 16 16">
                    <path
                ...
                <span class=" text-black ml-8 self-center text-xl font-semibold whitespace-nowrap dark:text-white">
                    <h1>
                        Bos
            ...
            <div class="flex items-center lg:order-2">
                {{-- <div class="hidden mt-2 mr-4 sm:inline-block">
                    <a class="github-button" href="https://github.com/themesberg/landwind" data-size="large"
                        data-icon="octicon-star" data-show-count="true"
                        aria-label="Star themesberg/landwind on GitHub">Star</a>
                </div> --}}
                {{-- <a href="#" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log in</a> --}}
                <a href="{{ route('booked') }}" class="flex md:order-2">
                    <button type="button"
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800">
                        BOOKING</button>
                ...
                <div class="text-white mr-4 hidden sm:flex sm:items-right sm:ml-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('favorit')">
                                {{ __('Favorit') }}
                            </x-dropdown-link>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <x-nav-link :href="route('card-comunity')" :active="request()->routeIs('card-comunity')">
                    {{ __('Community') }}
                </x-nav-link>
