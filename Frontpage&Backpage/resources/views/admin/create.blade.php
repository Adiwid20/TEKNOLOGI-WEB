                            ...
                            <div class="grid grid-cols-6 gap-6">
                                {{-- <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <div class="col-span-2 sm:col-span-4">
                                            ...
                                            <input type="text" name="id_category" id="email-address" 
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        </div>

                                <div class="col-span-6 sm:col-span-3">
                                    <label for="name_package" class="block text-sm font-medium text-gray-700">Package
                                        Name</label>
                                    <input type="text" name="name_package" id="package"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    <label for="comunity_id" class="block text-sm font-medium text-gray-700">
                                        ID Komunitas
                                    </label>
                                    <input type="text" name="comunity_id" id="email-address" 
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input type="text" name="facility" id="facility" autocomplete="facility"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="status" id="status" autocomplete="ready"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                <div class="col-span-2">
                                    <label for="time" class="block text-sm font-medium text-gray-700">Waktu
                                    </label>
                                    <input type="text" name="time" id="time" autocomplete="time"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                            ...
                            <div class="shadow sm:overflow-hidden sm:rounded-md">
                                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input type="file" name="image" id="image" {{-- autocomplete="time" --}}
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    </div>
