                                ...
                                <tr
                                    ...
                                    <td>
                                        <img class="w-36 h-36 rounded m-4"
                                            src="{{ asset($d->img_package) }}" alt="Extra large avatar">
                                    </td>
                                    ...
                                    <td class="py-4 px-6">
                                        <a href="#"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline break-all">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        ...
                                        <div class="flex item-center justify-center">
                                            ...
                                            {{-- EDIT --}}
                                            <div class="w-4 mr-2 transform hover:text-gray-100 hover:scale-110">
                                                <a 
                                                href="/admin/table/edit/{{ $d->package_id }}"
                                                >
                                               <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                                <a 
                                                href="/admin/table/destroy/{{ $d->package_id }}" onclick="return confirm('Are you sure want to delete the data')"
                                                > 
                                               <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
