...
<div class=" bg-gray-500 dark:bg-gray-800 py-12 " >
    <div class="max-w-5xl mx-5 sm:px-6 lg:px-10 bg" >
                    ...
                    <section>
                        ...
                        <div class="md:flex font-sans pt-8">
                            ...
                            <form class="p-6">
                                ...
                                <div class="flex space-x-4 mb-5 text-sm font-medium">
                                    ...
                                    <button
                                        class="flex-auto h-10 px-6 font-semibold rounded-full border border-slate-500 text-white hover:bg-violet-800 hover:border-none">
                                        Masukkan Keranjang
                                        <a href="#keranjangpage"></a>
                                    </button>
                        ...
                        <div class="md:flex font-sans pt-8">
                            ...
                            <form class="p-6">
                                ...
                                <div class="flex space-x-4 mb-5 text-sm font-medium">
                                    <div class="flex-auto flex space-x-4">
                                        <button class="h-10 px-6 font-semibold rounded-full border border-slate-500 text-white hover:bg-slate-500"
                                            type="submit">
                                            Book Now
                                        </button>
                                        <button data-bs-toggle="modal" data-bstarget="#exampleModalLg"
                                    ...
                                    <button
                                        class="flex-auto h-10 px-6 font-semibold rounded-full border border-slate-500 text-white hover:bg-slate-600 hover:border-none">
                                        Masukkan Keranjang
                                        <a href="#keranjang"></a>
                                    </button>
                                    <button
