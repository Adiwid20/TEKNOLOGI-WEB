<x-admin-layout>
    ...
    <body class="font-family-karla flex">
        <div class="relative flex-col h-screen overflow-y-hidden">

            <div
                class="antialiased bg-gradient-to-r from-violet-500 to-violet-900 w-full h-screen overflow-x-hidden border-t flex flex-col">
                <main class="mx-20  flex-grow p-6">

                    <div class="w-full">
                        <!-- source: https://tailwindcomponents.com/component/calendar-ui-with-tailwindcss-and-alpinejs -->
                        <div class="antialiased bg-gradient-to-r from-violet-500 to-violet-900">
                                    ...
                                    <div class="p-4 max-w-xl mx-auto  absolute left-0 right-0 overflow-hidden mt-24">
                                        ...
                                        <div class="shadow  rounded-lg bg-white overflow-hidden w-full block p-8">
                                            ...
                                            <div class="inline-block w-64 mb-4">
                                                <label
                                                    class="text-gray-800 block mb-1 font-bold text-sm tracking-wide">Select a theme</label>
                                                <div class="relative">
