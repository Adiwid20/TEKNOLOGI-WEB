...
<!-- Contact Form -->
    <div class="antialiased bg-gradient-to-r from-violet-500 to-violet-900 flex flex-wrap">
            ...
            <div class=" mx-10 leading-loose">
                <form class="p-10 bg-white rounded shadow-xl">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="message" name="message"
                            rows="6" required="" placeholder="Your inquiry.." aria-label="Email"></textarea>
                    </div>
                    <div class="mt-6">
                        <button class="px-4 py-1  text-white font-light tracking-wider antialiased bg-gradient-to-r from-violet-500 to-violet-900 rounded"
        ...
        <!-- Checkout Form -->
        <div class=" text-white text-2xl w-full lg:w-1/2 mt-6 pl-0 lg:pl-2">
            ...
            <div class="mx-10 leading-loose">
                <form class="p-10 bg-white rounded shadow-xl">
                    ...
                    <div class="mt-2">
                        ...
                        <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="cus_email"
